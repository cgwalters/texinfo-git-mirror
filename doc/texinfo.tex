...
%
\def\texinfoversion{2003-01-22.17}
%
...
% \fo@t, \f@@t, \f@t -- same as plain.
% 
% plain's \@foot does not have the \par; but we need it, because our
% paragraph parameters have changed, and would otherwise be reverted by
% the egroup before the paragraph is typeset.
