...
$result_trees{'simple_no_menu'}{'contents'}[3]{'contents'}[6]{'contents'}[1]{'contents'}[0]{'parent'} = $result_trees{'simple_no_menu'}{'contents'}[3]{'contents'}[6]{'contents'}[1];
$result_trees{'simple_no_menu'}{'contents'}[3]{'contents'}[6]{'contents'}[1]{'parent'} = $result_trees{'simple_no_menu'}{'contents'}[3]{'contents'}[6];
