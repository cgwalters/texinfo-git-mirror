...
$result_trees{'macro_and_args'}{'contents'}[1]{'extra'}{'command'} = $result_trees{'macro_and_args'}{'contents'}[0];
...
$result_trees{'macro_and_args'}{'contents'}[4]{'extra'}{'command'} = $result_trees{'macro_and_args'}{'contents'}[3];
