...
$result_trees{'ref_to_float'}{'contents'}[6]{'contents'}[0]{'extra'}{'label'} = $result_trees{'ref_to_float'}{'contents'}[0];
...
$result_trees{'ref_to_float'}{'contents'}[8]{'contents'}[0]{'extra'}{'label'} = $result_trees{'ref_to_float'}{'contents'}[3];
