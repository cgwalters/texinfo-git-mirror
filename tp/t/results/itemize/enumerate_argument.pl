...
$result_trees{'enumerate_argument'}{'contents'}[3]{'contents'}[0]{'parent'} = $result_trees{'enumerate_argument'}{'contents'}[3];
...
$result_trees{'enumerate_argument'}{'contents'}[6]{'contents'}[0]{'parent'} = $result_trees{'enumerate_argument'}{'contents'}[6];
