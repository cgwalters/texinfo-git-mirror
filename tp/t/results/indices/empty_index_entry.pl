...
$result_trees{'empty_index_entry'}{'contents'}[1]{'contents'}[4]{'args'}[0]{'contents'}[0]{'parent'} = $result_trees{'empty_index_entry'}{'contents'}[1]{'contents'}[4]{'args'}[0];
$result_trees{'empty_index_entry'}{'contents'}[1]{'contents'}[4]{'args'}[0]{'contents'}[1]{'parent'} = $result_trees{'empty_index_entry'}{'contents'}[1]{'contents'}[4]{'args'}[0];
$result_trees{'empty_index_entry'}{'contents'}[1]{'contents'}[4]{'args'}[0]{'contents'}[2]{'parent'} = $result_trees{'empty_index_entry'}{'contents'}[1]{'contents'}[4]{'args'}[0];
$result_trees{'empty_index_entry'}{'contents'}[1]{'contents'}[4]{'args'}[0]{'parent'} = $result_trees{'empty_index_entry'}{'contents'}[1]{'contents'}[4];
$result_trees{'empty_index_entry'}{'contents'}[1]{'contents'}[4]{'parent'} = $result_trees{'empty_index_entry'}{'contents'}[1];
