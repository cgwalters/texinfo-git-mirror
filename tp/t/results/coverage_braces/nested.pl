...
$result_converted{'html'}->{'nested'} = '<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html>
...
<p>type the characters <kbd>l o g o u t &lt;RET&gt;</kbd>.</p><p>
...
$result_converted_errors{'html'}->{'nested'} = [
  {
