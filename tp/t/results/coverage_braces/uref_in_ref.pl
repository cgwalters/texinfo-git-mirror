...
$result_converted{'html'}->{'uref_in_ref'} = '<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html>
...
<p><a href="index3.html#node">title with uref2 <a href="href://http/myhost.com/index2.html">uref2</a></a> in <cite>printed manual with uref4 <a href="href://http/myhost.com/index4.html">uref4</a></cite>
</p><p>
...
$result_converted_errors{'html'}->{'uref_in_ref'} = [
  {
