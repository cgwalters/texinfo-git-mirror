...
$result_converted{'html'}->{'footnote_ending_on_empty_line'} = '<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html>
...
$result_converted_errors{'html'}->{'footnote_ending_on_empty_line'} = [
  {
