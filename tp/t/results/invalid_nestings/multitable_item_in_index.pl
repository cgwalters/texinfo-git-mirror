...
$result_trees{'multitable_item_in_index'}{'contents'}[0]{'special'}{'prototypes'}[0] = $result_trees{'multitable_item_in_index'}{'contents'}[0]{'args'}[0]{'contents'}[1];
$result_trees{'multitable_item_in_index'}{'contents'}[0]{'special'}{'prototypes'}[1] = $result_trees{'multitable_item_in_index'}{'contents'}[0]{'args'}[0]{'contents'}[3];
