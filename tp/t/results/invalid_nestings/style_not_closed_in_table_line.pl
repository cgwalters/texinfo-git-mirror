...
$result_trees{'style_not_closed_in_table_line'}{'contents'}[0]{'contents'}[1]{'extra'}{'misc_content'}[0] = $result_trees{'style_not_closed_in_table_line'}{'contents'}[0]{'contents'}[1]{'args'}[0]{'contents'}[1];
