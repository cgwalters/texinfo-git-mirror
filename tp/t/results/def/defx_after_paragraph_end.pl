...
$result_trees{'defx_after_paragraph_end'}{'contents'}[0]{'contents'}[0]{'extra'}{'index_entry'}{'content'} = $result_trees{'defx_after_paragraph_end'}{'contents'}[0]{'contents'}[0]{'extra'}{'def_args'};
...
$result_trees{'defx_after_paragraph_end'}{'contents'}[0]{'contents'}[3]{'extra'}{'def_args'}[0][1] = $result_trees{'defx_after_paragraph_end'}{'contents'}[0]{'contents'}[3]{'args'}[0]{'contents'}[1];
...
$result_trees{'defx_after_paragraph_end'}{'contents'}[0]{'contents'}[3]{'extra'}{'index_entry'}{'content'} = $result_trees{'defx_after_paragraph_end'}{'contents'}[0]{'contents'}[3]{'extra'}{'def_args'};
