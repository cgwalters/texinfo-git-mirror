...
$result_trees{'defx_after_empty_line'}{'contents'}[0]{'contents'}[0]{'special'}{'def_args'}[2][1] = $result_trees{'defx_after_empty_line'}{'contents'}[0]{'contents'}[0]{'args'}[0]{'contents'}[2];
...
$result_trees{'defx_after_empty_line'}{'contents'}[0]{'contents'}[2]{'special'}{'def_args'}[0][1] = $result_trees{'defx_after_empty_line'}{'contents'}[0]{'contents'}[2]{'args'}[0]{'contents'}[1];
