...
$result_trees{'defx_after_text'}{'contents'}[0]{'contents'}[0]{'extra'}{'index_entry'}{'content'} = $result_trees{'defx_after_text'}{'contents'}[0]{'contents'}[0]{'extra'}{'def_args'};
...
$result_trees{'defx_after_text'}{'contents'}[0]{'contents'}[1]{'contents'}[1]{'extra'}{'index_entry'}{'content'} = $result_trees{'defx_after_text'}{'contents'}[0]{'contents'}[1]{'contents'}[1]{'extra'}{'def_args'};
