...
$result_trees{'defx_after_text'}{'contents'}[0]{'contents'}[0]{'special'}{'def_args'}[2][1] = $result_trees{'defx_after_text'}{'contents'}[0]{'contents'}[0]{'args'}[0]{'contents'}[2];
...
$result_trees{'defx_after_text'}{'contents'}[0]{'contents'}[1]{'contents'}[1]{'special'}{'def_args'}[0][1] = $result_trees{'defx_after_text'}{'contents'}[0]{'contents'}[1]{'contents'}[1]{'args'}[0]{'contents'}[1];
