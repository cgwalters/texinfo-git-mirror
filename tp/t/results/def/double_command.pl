...
$result_trees{'double_command'}{'contents'}[0]{'contents'}[0]{'special'}{'def_args'}[17][1] = $result_trees{'double_command'}{'contents'}[0]{'contents'}[0]{'args'}[0]{'contents'}[2];
...
$result_trees{'double_command'}{'contents'}[3]{'contents'}[0]{'special'}{'def_args'}[6][1] = $result_trees{'double_command'}{'contents'}[3]{'contents'}[0]{'args'}[0]{'contents'}[2];
