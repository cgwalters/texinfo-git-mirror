...
$result_trees{'sp'}{'contents'}[2]{'args'}[0]{'contents'}[0]{'extra'}{'command'} = $result_trees{'sp'}{'contents'}[2];
...
$result_trees{'sp'}{'contents'}[3]{'args'}[0]{'contents'}[0]{'extra'}{'command'} = $result_trees{'sp'}{'contents'}[3];
...
$result_trees{'sp'}{'contents'}[5]{'args'}[0]{'contents'}[0]{'extra'}{'command'} = $result_trees{'sp'}{'contents'}[5];
...
$result_trees{'sp'}{'contents'}[7]{'args'}[0]{'contents'}[0]{'extra'}{'command'} = $result_trees{'sp'}{'contents'}[7];
