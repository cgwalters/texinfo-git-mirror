...
$result_trees{'text_before_line_command'}{'contents'}[2]{'contents'}[4]{'extra'}{'author'} = $result_trees{'text_before_line_command'}{'contents'}[2]{'contents'}[4]{'contents'}[1]{'contents'}[1];
