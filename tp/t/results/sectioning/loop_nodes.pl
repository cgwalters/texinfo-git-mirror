...
$result_trees{'loop_nodes'}{'contents'}[2]{'contents'}[3]{'parent'} = $result_trees{'loop_nodes'}{'contents'}[2];
...
$result_trees{'loop_nodes'}{'contents'}[3]{'contents'}[3]{'parent'} = $result_trees{'loop_nodes'}{'contents'}[3];
...
$result_trees{'loop_nodes'}{'contents'}[4]{'contents'}[3]{'parent'} = $result_trees{'loop_nodes'}{'contents'}[4];
