...
$result_trees{'node'}{'contents'}[5]{'args'}[4]{'contents'}[2]{'parent'} = $result_trees{'node'}{'contents'}[5]{'args'}[4];
...
$result_trees{'node'}{'contents'}[7]{'args'}[0]{'contents'}[3]{'args'}[0]{'parent'} = $result_trees{'node'}{'contents'}[7]{'args'}[0]{'contents'}[3];
