...
$result_trees{'part_before_section'}{'contents'}[1]{'args'}[0]{'contents'}[0]{'extra'}{'command'} = $result_trees{'part_before_section'}{'contents'}[1];
...
$result_trees{'part_before_section'}{'contents'}[2]{'args'}[0]{'contents'}[0]{'extra'}{'command'} = $result_trees{'part_before_section'}{'contents'}[2];
