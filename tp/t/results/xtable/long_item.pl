...
$result_trees{'long_item'}{'contents'}[0]{'contents'}[2]{'args'}[0]{'contents'}[0]{'parent'} = $result_trees{'long_item'}{'contents'}[0]{'contents'}[2]{'args'}[0];
$result_trees{'long_item'}{'contents'}[0]{'contents'}[2]{'args'}[0]{'contents'}[1]{'parent'} = $result_trees{'long_item'}{'contents'}[0]{'contents'}[2]{'args'}[0];
$result_trees{'long_item'}{'contents'}[0]{'contents'}[2]{'args'}[0]{'contents'}[2]{'parent'} = $result_trees{'long_item'}{'contents'}[0]{'contents'}[2]{'args'}[0];
$result_trees{'long_item'}{'contents'}[0]{'contents'}[2]{'args'}[0]{'parent'} = $result_trees{'long_item'}{'contents'}[0]{'contents'}[2];
$result_trees{'long_item'}{'contents'}[0]{'contents'}[2]{'extra'}{'misc_content'}[0] = $result_trees{'long_item'}{'contents'}[0]{'contents'}[2]{'args'}[0]{'contents'}[1];
$result_trees{'long_item'}{'contents'}[0]{'contents'}[2]{'parent'} = $result_trees{'long_item'}{'contents'}[0];
$result_trees{'long_item'}{'contents'}[0]{'contents'}[3]{'parent'} = $result_trees{'long_item'}{'contents'}[0];
$result_trees{'long_item'}{'contents'}[0]{'contents'}[4]{'contents'}[0]{'parent'} = $result_trees{'long_item'}{'contents'}[0]{'contents'}[4];
$result_trees{'long_item'}{'contents'}[0]{'contents'}[4]{'parent'} = $result_trees{'long_item'}{'contents'}[0];
